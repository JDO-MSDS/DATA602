...
def exercise02():
    ...
    '''
    # ------ Place code below here \/ \/ \/ ------
    df2 = pd.read_csv("C:\\Users\\jpfer\\PycharmProjects\\python_course_2\\data.csv")
    print(df2.head())
    # ------ Place code above here /\ /\ /\ ------
    return df2
...
def exercise06():
    ...
    '''
    # ------ Place code below here \/ \/ \/ ------
    df6 = pd.read_excel("C:\\Users\\jpfer\\PycharmProjects\\python_course_2\\data.xlsx")
    df6.columns = ["A", "B", "C"]
    # ------ Place code above here /\ /\ /\ ------
    return df6
